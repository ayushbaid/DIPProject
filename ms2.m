...
plot(repmat(ssim0,1,MAX_ITERS)); M2='TVD';
plot(repmat(ssim2,1,MAX_ITERS)); M3='Wiener';
legend(M1,M2,M3);
...
plot(repmat(psnr0,1,MAX_ITERS)); M2='TVD';
plot(repmat(psnr2,1,MAX_ITERS)); M3='Wiener';
legend(M1,M2,M3);
xlabel('Iteration number');
ylabel('PSNR');
